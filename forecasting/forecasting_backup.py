...
def auto_forecast_fpna(df, date, measure, account_id_name, generic_cols_list,
                       ...
                       forecast_periods=12, min_history=12, fallback_window=12, max_lag=12,
    ...
    weights_df = (df[df['month'].dt.year==last_year]
                  .groupby(group_cols+detail_cols)[measure].sum().reset_index(name='detail_amount'))
